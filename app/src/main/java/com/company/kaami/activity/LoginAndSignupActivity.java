...
public class LoginAndSignupActivity extends AppCompatActivity {
    ...
    private ScrollingImageView scrollingBackground1;
    private TextView termsbt,privacybt,contentbt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_login_and_signup);
        scrollingBackground1 = findViewById(R.id.scrolling_background1);
        ...
        termsbt.setText(R.string.terms);
        privacybt.setText(R.string.privacy);
        contentbt.setText(R.string.content);
        ...
        mGoogleSignInClient = GoogleSignIn.getClient(LoginAndSignupActivity.this, gso);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginAndSignupActivity.this, "Authentication failed.",
